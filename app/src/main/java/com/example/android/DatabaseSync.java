...
public class DatabaseSync extends TimerTask {
    ...
    public void run() {
        ...
        Log.i(TAG, "USER: " + Global.currUser);
        ...
        if (Global.currUser != null) {
            ...
            Log.i(TAG, "curemail: " + Global.currUser.email);
            ...
            for (String photoPath : Global.uploadImageQueue) {
                photoStorage = new PhotoStorage(photoPath, storageReference);
